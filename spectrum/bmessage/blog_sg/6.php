...
<Variable name="SBbgColor" description="Sidebar Background Color"
 ...
 <Variable name="sidebarTitleBgColor" description="Sidebar Title Background Color"
           type="color" default="#6f3c1b" value="#e6e6e6">
 <Variable name="sidebarTitleTextColor" description="Sidebar Title Text Color"
           type="color" default="#b47b10" value="#808080">
 <Variable name="SBtextColor" description="Sidebar Text Color"
           type="color" default="#ffcc66" value="#063E3F">
...
<Variable name="SBLinkColor" description="Sidebar Link Color"
           type="color" default="#ffe6b3" value="#6C82B5">
 ...
 <Variable name="AltLinkColor1" description="Alternative Link Color 1"
           type="color" default="#e1771e" value="#ffffff">
...
#page {
	...
	margin-bottom: 0px;
	margin-left: auto;
	background-image: url(http://i33.tinypic.com/9a08es.jpg);
...
#header {
	...
	margin: 0px;
	padding: 0px;
	background-image: url(http://i35.tinypic.com/e0symg.jpg);
...
#footer {
	...
	margin-left: auto;
	color: #333333;
	background-image: url(http://i37.tinypic.com/m8mwyb.jpg);
	}
#footer a {
  color: #333333;
}
...
<DIV id='powered'>
<A href='http://www.blogspottemplate.com'>Free Blogger Templates</A> by <A href='http://www.isnaini.com'>Isnaini Dot Com</A> and <a href='http://www.archithings.com'>Home Improvement</a>. Powered by <A href='http://www.blogger.com'>Blogger</A>
</DIV>
