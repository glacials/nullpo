...
<Variable name="bgColor" description="Page Background Color"
 ...
 <Variable name="textColor" description="Text Color"
           type="color" default="#ffcc66" value="#666666">
<Variable name="linkColor" description="Link Color"
           type="color" default="#ffffff" value="#cc0000">
 <Variable name="HoverlinkColor" description="Hover Link Color"
           type="color" default="#ffff66" value="#000000">
 ...
 <Variable name="PostTitleHoverlinkColor" description="Post Title Hover link Color"
           type="color" default="#ffff66" value="#322527">
 <Variable name="dateHeaderColor" description="Date Header Color"
           type="color" default="#825227" value="#808080">
...
<Variable name="SBbgColor" description="Sidebar Background Color"
           type="color" default="#825227" value="#FEBCC6">
 ...
 <Variable name="sidebarTitleBgColor" description="Sidebar Title Background Color"
           type="color" default="#6f3c1b" value="#ff8080">
 <Variable name="sidebarTitleTextColor" description="Sidebar Title Text Color"
           type="color" default="#b47b10" value="#ffffff">
 <Variable name="SBtextColor" description="Sidebar Text Color"
           type="color" default="#ffcc66" value="#7f7f7f">
...
<Variable name="SBLinkColor" description="Sidebar Link Color"
           type="color" default="#ffe6b3" value="#cc0000">
 ...
 <Variable name="AltLinkColor1" description="Alternative Link Color 1"
           type="color" default="#e1771e" value="#940f04">
...
#page {
	...
	margin-bottom: 0px;
	margin-left: auto;
	background-image: url(http://i25.tinypic.com/zlxjxk.jpg);
...
#header {
	...
	margin: 0px;
	padding: 0px;
	background-image: url(http://i29.tinypic.com/2e55xt4.jpg);
...
#footer {
	...
	margin-left: auto;
	color: #333333;
	background-image: url(http://i30.tinypic.com/2rc8tvk.jpg);
	}
#footer a {
  color: #333333;
}
...
<SMALL><A href='http://www.blogspottemplate.com'>Blogger Templates</A> by <A href='http://www.isnaini.com'>Isnaini Dot Com</A> and <a href='http://www.archithings.com/category/home-improvement'>Home Improvement</a>.</SMALL>
</DIV>
