...
<Variable name="bgColor" description="Page Background Color"
           type="color" default="#333333" value="#8EB252">
...
<Variable name="linkColor" description="Link Color"
 ...
 <Variable name="HoverlinkColor" description="Hover Link Color"
           type="color" default="#ffff66" value="#1B703A">
...
<Variable name="SBbgColor" description="Sidebar Background Color"
 ...
 <Variable name="sidebarTitleBgColor" description="Sidebar Title Background Color"
           type="color" default="#6f3c1b" value="#F55132">
 <Variable name="sidebarTitleTextColor" description="Sidebar Title Text Color"
           type="color" default="#b47b10" value="#eeffd1">
...
#page {
	...
	margin-bottom: 0px;
	margin-left: auto;
	background-image: url(http://i36.tinypic.com/2z3s7f6.jpg);
...
#header {
	...
	margin: 0px;
	padding: 0px;
	background-image: url(http://i37.tinypic.com/2aerxbo.jpg);
...
#footer {
	...
	margin-left: auto;
	color: #333333;
	background-image: url(http://i36.tinypic.com/ezleo4.jpg);
	}
#footer a {
  color: #333333;
}
...
<DIV id='powered'>
<A href='http://www.blogspottemplate.com'>Free Blogger Templates</A> by <A href='http://www.isnaini.com'>Isnaini Dot Com</A> and <a href='http://www.archithings.com'>Archithings</a>. Powered by <A href='http://www.blogger.com'>Blogger</A>
</DIV>
