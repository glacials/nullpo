...
<div id="pagecontent">
	...
	<?php echo (isset($this->_tpldata['DEFINE']['.']['CA_CAP_START'])) ? $this->_tpldata['DEFINE']['.']['CA_CAP_START'] : ''; echo ((isset($this->_rootref['L_VIEWING_PROFILE'])) ? $this->_rootref['L_VIEWING_PROFILE'] : ((isset($user->lang['VIEWING_PROFILE'])) ? $user->lang['VIEWING_PROFILE'] : '{ VIEWING_PROFILE }')); echo (isset($this->_tpldata['DEFINE']['.']['CA_CAP_END'])) ? $this->_tpldata['DEFINE']['.']['CA_CAP_END'] : ''; ?>
	...
	<tr>
		<td class="row1" align="center">
			...
			<tr>
				<td align="center" class="error"><b class="gen"><?php echo ((isset($this->_rootref['L_USER_IS_INACTIVE'])) ? $this->_rootref['L_USER_IS_INACTIVE'] : ((isset($user->lang['USER_IS_INACTIVE'])) ? $user->lang['USER_IS_INACTIVE'] : '{ USER_IS_INACTIVE }')); ?></b><br /><?php echo ((isset($this->_rootref['L_INACTIVE_REASON'])) ? $this->_rootref['L_INACTIVE_REASON'] : ((isset($user->lang['INACTIVE_REASON'])) ? $user->lang['INACTIVE_REASON'] : '{ INACTIVE_REASON }')); ?>: <?php echo (isset($this->_rootref['USER_INACTIVE_REASON'])) ? $this->_rootref['USER_INACTIVE_REASON'] : ''; ?><br /><br /></td>
			</tr>
			<?php } ?>

			<tr>
				<td align="center"><?php if ($this->_rootref['USER_COLOR']) {  ?><b class="gen" style="color: <?php echo (isset($this->_rootref['USER_COLOR'])) ? $this->_rootref['USER_COLOR'] : ''; ?>"><?php } else { ?><b class="gen"><?php } echo (isset($this->_rootref['USERNAME'])) ? $this->_rootref['USERNAME'] : ''; ?></b><?php if ($this->_rootref['U_USER_ADMIN']) {  ?><span class="genmed"><br />[ <a href="<?php echo (isset($this->_rootref['U_USER_ADMIN'])) ? $this->_rootref['U_USER_ADMIN'] : ''; ?>"><?php echo ((isset($this->_rootref['L_USER_ADMIN'])) ? $this->_rootref['L_USER_ADMIN'] : ((isset($user->lang['USER_ADMIN'])) ? $user->lang['USER_ADMIN'] : '{ USER_ADMIN }')); ?></a> ]</span><?php } ?></td>
			</tr>
			<?php if ($this->_rootref['RANK_TITLE']) {  ?>

				<tr>
					<td align="center"><?php echo (isset($this->_rootref['RANK_TITLE'])) ? $this->_rootref['RANK_TITLE'] : ''; ?></td>
				</tr>
		...
		<td class="row1">
			...
			<tr>
				...
				<?php if ($this->_rootref['POSTER_INVITE_INVITER'] && $this->_rootref['S_P_DISPLAY_INVITER']) {  ?>

			<tr>
				<td class="gen" align="<?php echo (isset($this->_rootref['S_CONTENT_FLOW_END'])) ? $this->_rootref['S_CONTENT_FLOW_END'] : ''; ?>" nowrap="nowrap"><?php echo ((isset($this->_rootref['L_DISPLAY_INVITER'])) ? $this->_rootref['L_DISPLAY_INVITER'] : ((isset($user->lang['DISPLAY_INVITER'])) ? $user->lang['DISPLAY_INVITER'] : '{ DISPLAY_INVITER }')); ?>: </td>
				<td width="100%"><b class="gen"><?php echo (isset($this->_rootref['POSTER_INVITE_INVITER'])) ? $this->_rootref['POSTER_INVITE_INVITER'] : ''; ?></b></td>
			</tr>
			...
			<?php } if ($this->_rootref['S_P_DISPLAY_INVITE']) {  ?>

				<tr>
					<td class="gen" align="<?php echo (isset($this->_rootref['S_CONTENT_FLOW_END'])) ? $this->_rootref['S_CONTENT_FLOW_END'] : ''; ?>" valign="top" nowrap="nowrap"><?php echo ((isset($this->_rootref['L_DISPLAY_INVITE'])) ? $this->_rootref['L_DISPLAY_INVITE'] : ((isset($user->lang['DISPLAY_INVITE'])) ? $user->lang['DISPLAY_INVITE'] : '{ DISPLAY_INVITE }')); ?>:</td>
					<td><b><?php echo (isset($this->_rootref['POSTER_INVITE_INVITE'])) ? $this->_rootref['POSTER_INVITE_INVITE'] : ''; ?></b></td>
				</tr>
			<?php } if ($this->_rootref['S_P_DISPLAY_REGISTER']) {  ?>

				<tr>
					<td class="gen" align="<?php echo (isset($this->_rootref['S_CONTENT_FLOW_END'])) ? $this->_rootref['S_CONTENT_FLOW_END'] : ''; ?>" valign="top" nowrap="nowrap"><?php echo ((isset($this->_rootref['L_DISPLAY_REGISTER'])) ? $this->_rootref['L_DISPLAY_REGISTER'] : ((isset($user->lang['DISPLAY_REGISTER'])) ? $user->lang['DISPLAY_REGISTER'] : '{ DISPLAY_REGISTER }')); ?>: </td>
					<td><b><?php echo (isset($this->_rootref['POSTER_INVITE_REGISTER'])) ? $this->_rootref['POSTER_INVITE_REGISTER'] : ''; ?></b></td>
				</tr>
			<?php } if ($this->_rootref['POSTER_INVITE_NAME'] && $this->_rootref['S_P_DISPLAY_NAME']) {  ?>

				<tr>
					<td class="gen" align="<?php echo (isset($this->_rootref['S_CONTENT_FLOW_END'])) ? $this->_rootref['S_CONTENT_FLOW_END'] : ''; ?>" valign="top" nowrap="nowrap"><?php echo ((isset($this->_rootref['L_DISPLAY_NAME'])) ? $this->_rootref['L_DISPLAY_NAME'] : ((isset($user->lang['DISPLAY_NAME'])) ? $user->lang['DISPLAY_NAME'] : '{ DISPLAY_NAME }')); ?>: </td>
					<td><b><?php echo (isset($this->_rootref['POSTER_INVITE_NAME'])) ? $this->_rootref['POSTER_INVITE_NAME'] : ''; ?></b></td>
				</tr>
			<?php } ?>
