...
<div id="pagecontent">
	...
	<tr>
		...
		<?php } if ($this->_rootref['TOTAL_POSTS']) {  ?>
			...
			<td class="gensmall" width="100%" align="<?php echo (isset($this->_rootref['S_CONTENT_FLOW_END'])) ? $this->_rootref['S_CONTENT_FLOW_END'] : ''; ?>" nowrap="nowrap">
			<?php if (! $this->_rootref['S_IS_BOT']) {  if ($this->_rootref['U_WATCH_TOPIC']) {  ?><a href="<?php echo (isset($this->_rootref['U_WATCH_TOPIC'])) ? $this->_rootref['U_WATCH_TOPIC'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_WATCH_TOPIC'])) ? $this->_rootref['L_WATCH_TOPIC'] : ((isset($user->lang['WATCH_TOPIC'])) ? $user->lang['WATCH_TOPIC'] : '{ WATCH_TOPIC }')); ?>"><?php echo ((isset($this->_rootref['L_WATCH_TOPIC'])) ? $this->_rootref['L_WATCH_TOPIC'] : ((isset($user->lang['WATCH_TOPIC'])) ? $user->lang['WATCH_TOPIC'] : '{ WATCH_TOPIC }')); ?></a><?php } if ($this->_rootref['U_BOOKMARK_TOPIC']) {  ?>, <a href="<?php echo (isset($this->_rootref['U_BOOKMARK_TOPIC'])) ? $this->_rootref['U_BOOKMARK_TOPIC'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_BOOKMARK_TOPIC'])) ? $this->_rootref['L_BOOKMARK_TOPIC'] : ((isset($user->lang['BOOKMARK_TOPIC'])) ? $user->lang['BOOKMARK_TOPIC'] : '{ BOOKMARK_TOPIC }')); ?>"><?php echo ((isset($this->_rootref['L_BOOKMARK_TOPIC'])) ? $this->_rootref['L_BOOKMARK_TOPIC'] : ((isset($user->lang['BOOKMARK_TOPIC'])) ? $user->lang['BOOKMARK_TOPIC'] : '{ BOOKMARK_TOPIC }')); ?></a><?php if ($this->_rootref['U_PRINT_TOPIC'] || $this->_rootref['U_EMAIL_TOPIC'] || $this->_rootref['U_BUMP_TOPIC']) {  } } if ($this->_rootref['U_BUMP_TOPIC']) {  ?>, <a href="<?php echo (isset($this->_rootref['U_BUMP_TOPIC'])) ? $this->_rootref['U_BUMP_TOPIC'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_BUMP_TOPIC'])) ? $this->_rootref['L_BUMP_TOPIC'] : ((isset($user->lang['BUMP_TOPIC'])) ? $user->lang['BUMP_TOPIC'] : '{ BUMP_TOPIC }')); ?>"><?php echo ((isset($this->_rootref['L_BUMP_TOPIC'])) ? $this->_rootref['L_BUMP_TOPIC'] : ((isset($user->lang['BUMP_TOPIC'])) ? $user->lang['BUMP_TOPIC'] : '{ BUMP_TOPIC }')); ?></a><?php } ?><br />
...
<?php if ($this->_rootref['S_HAS_POLL']) {  ?>
	...
	<?php echo (isset($this->_tpldata['DEFINE']['.']['CA_CAP_START'])) ? $this->_tpldata['DEFINE']['.']['CA_CAP_START'] : ''; echo (isset($this->_rootref['TOPIC_TITLE'])) ? $this->_rootref['TOPIC_TITLE'] : ''; echo (isset($this->_tpldata['DEFINE']['.']['CA_CAP_END'])) ? $this->_tpldata['DEFINE']['.']['CA_CAP_END'] : ''; ?>
...
<?php } $_postrow_count = (isset($this->_tpldata['postrow'])) ? sizeof($this->_tpldata['postrow']) : 0;if ($_postrow_count) {for ($_postrow_i = 0; $_postrow_i < $_postrow_count; ++$_postrow_i){$_postrow_val = &$this->_tpldata['postrow'][$_postrow_i]; if ($_postrow_val['S_FIRST_ROW']) {  ?>
	...
	<?php } else { ?>
			...
			<td align="center" valign="top" class="row">
				...
				<div class="postauthor"<?php if ($_postrow_val['POST_AUTHOR_COLOUR']) {  ?> style="color: <?php echo $_postrow_val['POST_AUTHOR_COLOUR']; ?>"<?php } ?>>
        
        			<?php if ($this->_rootref['S_QR_ACTIVE']) {  if ($this->_rootref['S_QR_COLOR_NICK']) {  if ($_postrow_val['POST_AUTHOR_COLOUR']) {  ?>	
					<span style="color: <?php echo $_postrow_val['POST_AUTHOR_COLOUR']; ?>;" class="username-coloured"><?php echo $_postrow_val['POST_AUTHOR']; ?></span>
					<?php } else { ?>
				...
				<?php echo $_postrow_val['POST_AUTHOR_FULL']; ?>			
			<?php } ?>
				...
				<div class="postdetails">
					<?php if ($_postrow_val['POSTER_JOINED']) {  ?><br /><b><?php echo ((isset($this->_rootref['L_JOINED'])) ? $this->_rootref['L_JOINED'] : ((isset($user->lang['JOINED'])) ? $user->lang['JOINED'] : '{ JOINED }')); ?>:</b> <?php echo $_postrow_val['POSTER_JOINED']; } if ($_postrow_val['POSTER_INVITE_INVITER'] && $this->_rootref['S_T_DISPLAY_INVITER']) {  ?><br /><b><?php echo ((isset($this->_rootref['L_DISPLAY_INVITER'])) ? $this->_rootref['L_DISPLAY_INVITER'] : ((isset($user->lang['DISPLAY_INVITER'])) ? $user->lang['DISPLAY_INVITER'] : '{ DISPLAY_INVITER }')); ?>:</b> <?php echo $_postrow_val['POSTER_INVITE_INVITER']; } if ($_postrow_val['POSTER_POSTS'] != ('')) {  ?><br /><b><?php echo ((isset($this->_rootref['L_POSTS'])) ? $this->_rootref['L_POSTS'] : ((isset($user->lang['POSTS'])) ? $user->lang['POSTS'] : '{ POSTS }')); ?>:</b> <?php echo $_postrow_val['POSTER_POSTS']; } if ($_postrow_val['POSTER_FROM']) {  ?><br /><b><?php echo ((isset($this->_rootref['L_LOCATION'])) ? $this->_rootref['L_LOCATION'] : ((isset($user->lang['LOCATION'])) ? $user->lang['LOCATION'] : '{ LOCATION }')); ?>:</b> <?php echo $_postrow_val['POSTER_FROM']; } if ($this->_rootref['S_T_DISPLAY_INVITE']) {  ?><br /><b><?php echo ((isset($this->_rootref['L_DISPLAY_INVITE'])) ? $this->_rootref['L_DISPLAY_INVITE'] : ((isset($user->lang['DISPLAY_INVITE'])) ? $user->lang['DISPLAY_INVITE'] : '{ DISPLAY_INVITE }')); ?>:</b> <?php echo $_postrow_val['POSTER_INVITE_INVITE']; } if ($this->_rootref['S_T_DISPLAY_REGISTER']) {  ?><b><?php echo ((isset($this->_rootref['L_DISPLAY_REGISTER'])) ? $this->_rootref['L_DISPLAY_REGISTER'] : ((isset($user->lang['DISPLAY_REGISTER'])) ? $user->lang['DISPLAY_REGISTER'] : '{ DISPLAY_REGISTER }')); ?>:</b> <?php echo $_postrow_val['POSTER_INVITE_REGISTER']; } if ($_postrow_val['POSTER_INVITE_NAME'] && $this->_rootref['S_T_DISPLAY_NAME']) {  ?><b><?php echo ((isset($this->_rootref['L_DISPLAY_NAME'])) ? $this->_rootref['L_DISPLAY_NAME'] : ((isset($user->lang['DISPLAY_NAME'])) ? $user->lang['DISPLAY_NAME'] : '{ DISPLAY_NAME }')); ?>:</b> <?php echo $_postrow_val['POSTER_INVITE_NAME']; } if ($_postrow_val['S_PROFILE_FIELD1']) {  ?><!-- Use a construct like this to include admin defined profile fields. Replace FIELD1 with the name of your field. -->
			...
			<td width="100%" height="25" class="row" valign="top">
				...
				<div class="postsubject"><?php if ($this->_rootref['S_IS_BOT']) {  echo $_postrow_val['MINI_POST_IMG']; } else { ?><a href="<?php echo $_postrow_val['U_MINI_POST']; ?>"><?php echo $_postrow_val['MINI_POST_IMG']; ?></a><?php } ?>&nbsp;<?php echo $_postrow_val['POST_SUBJECT']; ?></div>
