...
<?php echo (isset($this->_tpldata['DEFINE']['.']['CA_CAP_START'])) ? $this->_tpldata['DEFINE']['.']['CA_CAP_START'] : ''; echo ((isset($this->_rootref['L_REGISTRATION'])) ? $this->_rootref['L_REGISTRATION'] : ((isset($user->lang['REGISTRATION'])) ? $user->lang['REGISTRATION'] : '{ REGISTRATION }')); echo (isset($this->_tpldata['DEFINE']['.']['CA_CAP_END'])) ? $this->_tpldata['DEFINE']['.']['CA_CAP_END'] : ''; ?>
...
<?php if ($this->_rootref['S_DISPLAY_REGISTER_KEY']) {  ?>

	<tr>
		<td class="row1"><b class="genmed"><?php echo ((isset($this->_rootref['L_REGISTER_KEY'])) ? $this->_rootref['L_REGISTER_KEY'] : ((isset($user->lang['REGISTER_KEY'])) ? $user->lang['REGISTER_KEY'] : '{ REGISTER_KEY }')); if ($this->_rootref['S_ENABLE_KEY_OPTIONAL']) {  ?>&nbsp; (<?php echo ((isset($this->_rootref['L_OPTIONAL'])) ? $this->_rootref['L_OPTIONAL'] : ((isset($user->lang['OPTIONAL'])) ? $user->lang['OPTIONAL'] : '{ OPTIONAL }')); ?>)<?php } ?>: </b><br /><span class="gensmall"><?php echo ((isset($this->_rootref['L_REGISTER_KEY_EXPLAIN'])) ? $this->_rootref['L_REGISTER_KEY_EXPLAIN'] : ((isset($user->lang['REGISTER_KEY_EXPLAIN'])) ? $user->lang['REGISTER_KEY_EXPLAIN'] : '{ REGISTER_KEY_EXPLAIN }')); ?></span></td>
		<td class="row2"><input class="post" type="text" name="key" size="25" value="<?php echo (isset($this->_rootref['REGISTER_KEY'])) ? $this->_rootref['REGISTER_KEY'] : ''; ?>" /></td>
	</tr>
<?php } ?>
