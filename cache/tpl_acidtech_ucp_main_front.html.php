...
<?php echo (isset($this->_tpldata['DEFINE']['.']['CA_CAP_START'])) ? $this->_tpldata['DEFINE']['.']['CA_CAP_START'] : ''; echo ((isset($this->_rootref['L_UCP'])) ? $this->_rootref['L_UCP'] : ((isset($user->lang['UCP'])) ? $user->lang['UCP'] : '{ UCP }')); echo (isset($this->_tpldata['DEFINE']['.']['CA_CAP_END'])) ? $this->_tpldata['DEFINE']['.']['CA_CAP_END'] : ''; ?>
...
<?php $_topicrow_count = (isset($this->_tpldata['topicrow'])) ? sizeof($this->_tpldata['topicrow']) : 0;if ($_topicrow_count) {for ($_topicrow_i = 0; $_topicrow_i < $_topicrow_count; ++$_topicrow_i){$_topicrow_val = &$this->_tpldata['topicrow'][$_topicrow_i]; if (!($_topicrow_val['S_ROW_COUNT'] & 1)  ) {  ?><tr class="row1"><?php } else { ?><tr class="row2"><?php } ?>
		...
		<td class="row" width="25" align="center"><?php echo $_topicrow_val['TOPIC_FOLDER_IMG']; ?></td>
		...
		<td class="row" width="120" align="center" nowrap="nowrap">
...
<?php }} else { ?>
	...
	<tr>
		<td class="row1" align="center" colspan="3"><b class="gen"><?php echo ((isset($this->_rootref['L_NO_IMPORTANT_NEWS'])) ? $this->_rootref['L_NO_IMPORTANT_NEWS'] : ((isset($user->lang['NO_IMPORTANT_NEWS'])) ? $user->lang['NO_IMPORTANT_NEWS'] : '{ NO_IMPORTANT_NEWS }')); ?></b></td>
	</tr>
<?php } ?>
