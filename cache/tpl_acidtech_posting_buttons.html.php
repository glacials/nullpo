...
<tr>
	<td id="helpline"<?php if ($this->_tpldata['DEFINE']['.']['S_SIGNATURE'] || $this->_rootref['S_EDIT_DRAFT']) {  ?> colspan="2"<?php } ?>><?php echo ((isset($this->_rootref['L_STYLES_TIP'])) ? $this->_rootref['L_STYLES_TIP'] : ((isset($user->lang['STYLES_TIP'])) ? $user->lang['STYLES_TIP'] : '{ STYLES_TIP }')); ?>&nbsp;</td>
